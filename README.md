...
USAGE:
The program is wizard driven (curses-ey) and you specify things such as the following:
...
* If you plug a USB-Serial dongle into your pi, and connect it to it over a null modem cable with Minicom, you can log in headlessly.
